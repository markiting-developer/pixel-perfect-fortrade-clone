  ...
  return (
    <>
      <div className="flex items-start gap-2 sm:gap-3 mt-4 sm:mt-6">
        ...
        />
        <label htmlFor="agreement" className="text-xs sm:text-sm text-white leading-relaxed font-normal">
          I agree to share my details to Fortrade.com and create a demo trading account.
        </label>
      </div>

      <div className="text-xs sm:text-sm leading-relaxed mt-3 sm:mt-4 font-normal text-white/90">
        <p>
      ...
      <div className="text-center mt-4 sm:mt-6 space-y-2">
        <p className="text-[#448AFF] text-xs sm:text-sm font-normal hover:text-[#5A9AFF] transition-colors cursor-pointer">
